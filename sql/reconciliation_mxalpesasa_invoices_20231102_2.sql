...
all_data as 
(
select a.bkup_agreement agreement, a.purchase_order po, a.asin, a.amazon_fee_quantity amazon_billed_qty, 'MXN' as agreement_currency, --a.amazon_fee_net_receipts, 
