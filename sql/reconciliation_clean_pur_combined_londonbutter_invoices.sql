select distinct(payee) from dc_raw.ds_astralbeauty_pur_1p_invoices_details limit 100
with 
dist_agreements as 
(
select distinct agreement_number, agreement_title , agreement_pct, agreement_start_date , agreement_end_date from dc_raw.ds_astralbeauty_pur_1p_agreements
...
from dc_raw.ds_astralbeauty_pur_1p_backupreport b 
left join dc_raw.ds_astralbeauty_pur_1p_backupreport_revised br on b.asin=br.asin and b.purchase_order=br.purchase_order and b.bkup_agreement =br.bkup_agreement and b.transaction_type =br.transaction_type 
...
dc_raw.ds_astralbeauty_pur_1p_backupreport_revised where old_invoice_quantity =0 and transaction_type='Distributor Shipment'
),
...
br left join dc_raw.ds_astralbeauty_pur_1p_agreements 
...
pur_london_invoices_details as 
(
select * from dc_raw.ds_astralbeauty_pur_1p_invoices_details union all
select * from dc_raw.ds_astralbeauty_londonbutter_1p_invoices_details 
),
