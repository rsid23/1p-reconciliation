drop table dc_raw.ds_astralbeauty_lewishyman_1p_backupreport;
create table dc_raw.ds_astralbeauty_lewishyman_1p_backupreport
(
receive_date date,
return_date date,
invoice_day date,
...
create table dc_raw.ds_astralbeauty_lewishyman_1p_backupreport_revised 
(
receive_date date,
return_date date,
invoice_day date,
...
COPY dc_raw.ds_betterbeing_1p_backupreport_revised (receive_date, return_date, invoice_day, transaction_type, net_receipts, net_receipts_currency, list_price, list_price_currency, revised_invoice_quantity, revised_invoice_rebate, rebate_currency, new_quantity, new_rebate, old_invoice_quantity, old_invoice_rebate, purchase_order, asin, upc, ean, manufacturer, distributor, product_group, category, subcategory, title, product_description, binding, cost_currency, old_cost, new_cost, price_protection_agreement, price_protection_day, cost_variance, invoice, multi_country_parent_agreement_id, bkup_agreement, bkup_invoice, bkup_invoicelinetype, bkup_file) from 's3://iderive-ds-models/vendor_central_betterbeing_1p/backupreports_revised/2022' iam_role 'arn:aws:iam::467175486680:role/iderive-ds-reads3' format csv delimiter as ',' ignoreheader 1 BLANKSASNULL DATEFORMAT 'auto';


--2023
COPY dc_raw.ds_astralbeauty_lewishyman_1p_backupreport (receive_date, return_date, invoice_day, transaction_type, quantity, net_receipts, net_receipts_currency, list_price, list_price_currency, rebate_in_agreement_currency, agreement_currency, rebate_in_purchase_order_currency, purchase_order_currency, purchase_order, asin, upc, ean, manufacturer, distributor, product_group, category, subcategory, title, product_description, binding, cost_currency, old_cost, new_cost, price_protection_agreement, price_protection_day, cost_variance, invoice, multi_country_parent_agreement_id, bkup_agreement, bkup_invoice, bkup_invoicelinetype, bkup_file) from 's3://iderive-ds-1p-reconciliation/astralbeauty/lewishyman/backupreports/2023/' iam_role 'arn:aws:iam::467175486680:role/iderive-ds-reads3' format csv delimiter as ',' ignoreheader 1 BLANKSASNULL DATEFORMAT 'auto';
--2022
COPY dc_raw.ds_astralbeauty_lewishyman_1p_backupreport (receive_date, return_date, invoice_day, transaction_type, quantity, net_receipts, net_receipts_currency, list_price, list_price_currency, rebate_in_agreement_currency, agreement_currency, rebate_in_purchase_order_currency, purchase_order_currency, purchase_order, asin, upc, ean, manufacturer, distributor, product_group, category, subcategory, title, product_description, binding, cost_currency, old_cost, new_cost, price_protection_agreement, price_protection_day, cost_variance, invoice, multi_country_parent_agreement_id, bkup_agreement, bkup_invoice, bkup_invoicelinetype, bkup_file) from 's3://iderive-ds-1p-reconciliation/astralbeauty/lewishyman/backupreports/2022/' iam_role 'arn:aws:iam::467175486680:role/iderive-ds-reads3' format csv delimiter as ',' ignoreheader 1 BLANKSASNULL DATEFORMAT 'auto';
--2021
COPY dc_raw.ds_astralbeauty_lewishyman_1p_backupreport (receive_date, return_date, invoice_day, transaction_type, quantity, net_receipts, net_receipts_currency, list_price, list_price_currency, rebate_in_agreement_currency, agreement_currency, rebate_in_purchase_order_currency, purchase_order_currency, purchase_order, asin, upc, ean, manufacturer, distributor, product_group, category, subcategory, title, product_description, binding, cost_currency, old_cost, new_cost, price_protection_agreement, price_protection_day, cost_variance, invoice, multi_country_parent_agreement_id, bkup_agreement, bkup_invoice, bkup_invoicelinetype, bkup_file) from 's3://iderive-ds-1p-reconciliation/astralbeauty/lewishyman/backupreports/2021/' iam_role 'arn:aws:iam::467175486680:role/iderive-ds-reads3' format csv delimiter as ',' ignoreheader 1 BLANKSASNULL DATEFORMAT 'auto';
