...
(
select distinct invoice_number from id_genexa.ds_1p_agreements where agreement_pct is null
),
...
from id_genexa.ds_1p_backupreport where bkup_invoice in (select invoice_number from dist_provisional_invoices)
and net_receipts >0
...
dist_agreements as 
(
select distinct agreement_number, agreement_title , agreement_pct, agreement_start_date , agreement_end_date from id_genexa.ds_1p_agreements
...
from id_genexa.ds_1p_backupreport b 
left join id_genexa.ds_1p_backupreport_revised br on b.asin=br.asin and b.purchase_order=br.purchase_order and b.bkup_agreement =br.bkup_agreement and b.transaction_type =br.transaction_type 
...
id_genexa.ds_1p_backupreport_revised where old_invoice_quantity =0 and transaction_type='Distributor Shipment'
),
...
br left join id_genexa.ds_1p_agreements 
...
(
select * from id_genexa.ds_1p_invoices_details
--union all
...
--select o.*, a.agreement_title, a.agreement_pct, a.agreement_start_date, a.agreement_end_date from overbill_totals2 o left join dist_agreements a on o.agreement=a.agreement_number
